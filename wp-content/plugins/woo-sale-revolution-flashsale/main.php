 ...
 */
 ...
 24-07-2015		ver 2.7
	Fix : don't show product in dropdown if products is above 1000
	fix : changed get_categorys with get_terms(in wordpress 4.2.x)
	fix : woocommerce variable sale price discount
	Add : capabilities woocommerce Brand Plugin
 ...
 14-03-2015		ver 2.2
	Fix : Price product in Sale and regular
