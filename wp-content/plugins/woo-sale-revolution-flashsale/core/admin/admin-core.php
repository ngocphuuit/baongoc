	...
	if(@$_GET['pw_action_type']=="add" || @$_GET['pw_action_type']=="edit" || @$_GET['pw_action_type']=="delete" || @$_GET['pw_action_type']=="status")
	{
		...
		if(@$_GET['pw_action_type']=="edit"){
			...
			if(isset($_GET['pw_id']))
			{
				...
				{					
					$pw_product_brand=get_post_meta($_GET['pw_id'],'pw_product_brand',true);
					$pw_except_product_brand=get_post_meta($_GET['pw_id'],'pw_except_product_brand',true);
				}
...
else
{
	...
	if(@$_GET['pw_action_type']=="add" || @$_GET['pw_action_type']=="edit" || @$_GET['pw_action_type']=="delete" || @$_GET['pw_action_type']=="status")
	{
		$pw_product_category=$pw_except_product_category=$pw_product_tag=$pw_except_product_tag=$pw_product_brand=$pw_except_product_brand=$pw_product=
