...
?>
    <form id="pw_create_level_form" class="pw_create_level_form" method="POST">	
        <table class="form-table pw-fs-table">
			...
			{
			?>
				<tr id="pw_product_brand" class="discount_apply_to">
					<td>
						<?php _e('Brand', 'pw_wc_flash_sale') ?>
					</td>
					<td>
					   <div>
						<?php
				...
				<tr id="pw_except_product_brand" class="discount_apply_to">
					<td>
						<?php _e('Except Brand', 'pw_wc_flash_sale') ?>
					</td>
					<td>
					   <div>
						<?php
