...
function fn_scx_get_opts() {
	...
	$opts['general'] = array(
		...
		array(
			'id' 		=> 'display',
			'name' 		=> __( 'Display', 'schat' ) . fn_scx_admin_desc( sprintf( __( "<a href='%s' target='_blank'>wp_footer()</a> <span class='scx-ico-new-win'></span> function has to be located in your theme", 'schat' ), 'http://codex.wordpress.org/Function_Reference/wp_footer' ), true ),
			'options' 	=> array(
		...
		array(
			'desc'		=> '<a href="#" id="scx-btn-specific-pages">' . __( 'Specific pages & categories', 'schat' ) . ' &raquo;</a>',
			'type' 		=> 'note'
		),
		...
		array(
			'id' => 'api-key',
			'name' => '<span class="dashicons dashicons-post-status"></span> ' . __( 'Screets API Key', 'schat' ) . ' <span class="scx-red">*</span>',
			'desc' => '<strong>' . sprintf( __( '<a href="%s" target="_blank">Get your API key</a>', 'schat' ), 'http://screets.org/apps/api/v1/keys/?domain=' . fn_scx_current_domain() ) . '</strong> <span class="scx-ico-new-win"></span><br>' . __( 'It is required to activate the plugin and get <strong>free updates</strong>.', 'schat' ) . '<br><small>* ' . __( 'Note that you might need to re-login WordPress after updating your API key.', 'schat' ) . '</small>',
			'type' => 'text'
		)
	...
	$opts['site-info'] = array(
		...
		array(
			'id' => 'site-name',
			'name' => __( 'Site name', 'schat' ) . '  <span class="scx-red">*</span>',
		...
		array(
			'id' => 'site-url',
			'name' => __( 'Site url', 'schat' ) . '  <span class="scx-red">*</span>',
		...
		array(
			'id' => 'site-email',
			'name' => __( 'Site email address(es)', 'schat' ) . '  <span class="scx-red">*</span>' . fn_scx_admin_desc( __( 'The plugin notifications will be sent to this email address', 'schat' ) . '.<br/><br/>' . sprintf( __( 'If you need SMTP configuration, you will want to use %s plugin or other good one', 'schat' ), '<a href="https://wordpress.org/plugins/easy-wp-smtp/" target="_blank">Easy WP SMTP</a> <span class="scx-ico-new-win"></span>' ), true ),
		...
		array(
			'id' => 'site-reply-to',
			'name' => __( 'Site reply-to address', 'schat' ) . '  <span class="scx-red">*</span>' . fn_scx_admin_desc( __( 'Your visitors will reply to this email', 'schat' ), true ),
		...
		array(
			'id' => 'social-twitter',
			'name' => __( 'Social links', 'schat' ) . fn_scx_admin_desc( __( 'Enter full URL (i.e. https://twitter.com/screetscom)', 'schat' ), true ),
			'placeholder' => 'Twitter',
	...
	$opts['design'] = array(
		...
		array(
			'id' 		=> 'offset-x',
			'name'		=> __( 'Horizontal offset', 'schat' ) . fn_scx_admin_desc( __( 'Sets the horizontal distance between the page bottom and the chat widget', 'schat' ), true ),
			'unit' 		=> 'px',
			'default' 	=> 20,
			'max' 		=> 100,
			'type' 		=> 'number'
		...
		array(
			'id' 		=> 'offset-y',
			'name'		=> __( 'Vertical offset', 'schat' ) . fn_scx_admin_desc( __( 'Sets the vertical distance between the edge of page and the chat widget', 'schat' ), true ),
			'unit' 		=> 'px',
			'default' 	=> 20,
			'max' 		=> 100,
			'type' 		=> 'number',
		...
		array(
			...
			'desc' 			=> __( 'Show Screets logo', 'schat' ) . fn_scx_admin_desc( __( 'It will help us to increase the plugin popularity and create better community. A good community brings lots of benefits like extensions, new ideas and improvements.', 'schat' ), true ),
			'default' 		=> true,
			'type' 			=> 'checkbox'
		),
	...
	$opts['users'] = array(
		...
		array(
			'id' 			=> 'guest-prefix',
			'name' 			=> __( 'Guest prefix', 'schat' ) . '  <span class="scx-red">*</span>',
		...
		array(
			'id' 		=> 'op-caps',
			'name' 		=> '<span class="dashicons dashicons-admin-network"></span> ' . __( 'Operator capabilities', 'schat' ) . fn_scx_admin_desc( sprintf( __( 'To add more capabilities to CX Operators, consider to use %s plugin or other good one', 'schat' ), '<a href="https://wordpress.org/plugins/wpfront-user-role-editor/" target="_blank">WPFront User Role Editor</a> <span class="scx-ico-new-win"></span>' ), true ),
			'options' 	=> array(
				'answer_visitors' => __( 'Use chat console and answer visitors', 'schat' ) . ' &nbsp; <small class="description">(scx_answer_visitor)</small>',
				'see_chat_logs' => __( 'See chat logs', 'schat' ) . ' &nbsp; <small class="description">(scx_see_logs)</small>',
				'manage_chat_options' => __( 'Manage chat options', 'schat' ) . ' &nbsp; <small class="description">(scx_manage_chat_options)</small>'
			),
	...
	$opts['integrations'] = array(
		...
		/*array(
			'desc' 			=> '<div class="scx-firebase-ntf update-nag"><p>' . sprintf( __( 'Create new project with <a href="%s" target="_blank">Google Firebase API</a>', 'schat' ), 'https://console.firebase.google.com' ) . ' <span class="scx-ico-new-win"></span>.',
			'type' 			=> 'note'
		),*/
		...
		array(
			'desc' 			=> '<h3 style="margin-top:0">How to setup?</h3><ol style="margin:0 0 0 15px;">
				...
				<li>Add <span class="scx-red">' . fn_scx_current_domain() . '</span> to <strong>"OAuth redirect domains"</strong> section on the same page.</li>
			</ol>',
			'type' 			=> 'note'
		),
		...
		array(
			'id' 			=> 'app-auth',
			'name' 			=> 'Auth Domain  <span class="scx-red">*</span>',
		...
		array(
			'id' 			=> 'app-db',
			'name' 			=> 'Database URL  <span class="scx-red">*</span>',
		...
		array(
			'id' 			=> 'app-bucket',
			'name' 			=> 'Storage Bucket  <span class="scx-red">*</span>',
			'desc' 			=> 'If you don\'t see storageBucket, please refresh Firebase console page and re-check again.',
		...
		/*array(
			'id' 			=> 'app-snippet',
			'name' 			=> 'Web Snippet  <span class="scx-red">*</span>',
		...
		/*array(
			'id' 			=> 'app-id',
			'name' 			=> 'App ID  <span class="scx-red">*</span>' . fn_scx_admin_desc( __( 'Your application name', 'schat' ) . '. <a href="https://www.firebase.com/signup/" target="_blank">' . sprintf( __( 'Create free %s account', 'schat' ), 'Firebase' ) . '</a> <span class="scx-ico-new-win"></span>', true ),
		...
		array(
			'id' 			=> 'app-secret',
			'name' 			=> 'Secret  <span class="scx-red">*</span>' . fn_scx_admin_desc( sprintf( __( '%s secret key can be found under "%s" menu in your %s dashboard', 'schat' ), 'Firebase', 'SECRETS', 'Firebase' ), true ),
			'placeholder'	=> 'Secret',
			'type' 			=> 'text'
		),
		...
		array(
			...
			'custom'		=> '<div class="scx-anonymous-auth">' . __( 'Checking', 'schat' ) . '...</div>',
			'type' 			=> 'custom'
		),

		array(
			'id' 			=> 'debug',
			'name' 			=> __( 'Debug', 'schat' ) . fn_scx_admin_desc( __( 'Activate debugging when there is an issue on the plugin', 'schat' ), true ),
		...
		array(
			'id' 			=> 'gm-api',
			'name' 			=> 'Google Maps API Key' . fn_scx_admin_desc( __( 'Helps you to see user locations on map in chat console', 'schat' ), true ),
			'placeholder'	=> 'API Key',
			'desc'			=> '<a href="https://developers.google.com/maps/documentation/javascript/tutorial#api_key" target="_blank">' . __( 'Get your API key', 'schat' ) . '</a> <span class="scx-ico-new-win"></span>',
			'type' 			=> 'text'
		),*/
		...
		array(
			'id' 			=> 'pushover-active',
			'name' 			=> __( 'Enable', 'schat' ) . fn_scx_admin_desc( __( 'Install Pushover to your mobile device or desktop (Mac or PC) and receive notifications from the plugin', 'schat' ) . '<br><a href="http://pushover.net" target="_blank">http://pushover.net</a> <span class="scx-ico-new-win"></span>', true ),
		...
		array(
			'desc' 			=> __( 'Use that image below as "App Icon" when creating your Pushover application:<br><a href="' . SCX_URL . '/assets/img/logos/chatx-logo-72px.png" target="_blank"><img src="' . SCX_URL . '/assets/img/logos/chatx-logo-72px.png" height="30" alt=""></a>', 'schat' ),
			'type' 			=> 'note'
		),
		...
		array(
			...
			'desc' 			=> '<a href="https://pushover.net/apps/build" target="_blank">' . __( 'Create an application and get your keys', 'schat' ) . '</a> <span class="scx-ico-new-win"></span><br>User key is viewable when logged into <a href="https://pushover.net/dashboard" target="_blank">Pushover dashboard</a> <span class="scx-ico-new-win"></span>',
			'type' 			=> 'text'
		),
