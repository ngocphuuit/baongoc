...
<div id="theme-wrapper">
	...
	<div class="<?php echo esc_attr(MAD_THEME_HELPER::page_layout()) ?>">

		<!-- - - - - - - - - - - - - - Header - - - - - - - - - - - - - - - - -->

		<header id="header" data-shrink="<?php echo (mad_custom_get_option('sticky_navigation')) ? 1 : 0; ?>" class="<?php echo esc_attr(MAD_THEME_HELPER::header_layout()) ?> <?php echo esc_attr(MAD_THEME_HELPER::header_full_width()); ?>">
			...
			<?php $mad_header_layout = mad_meta('mad_header_layout', '', $mad_post_id);
		...
		<?php $mad_sidebar_position = MAD_THEME_HELPER::template_layout_class('sidebar_position'); ?>
