		...
		<div class="team-members clearfix">
			...
			<?php foreach ($this->entries->posts as $entry): ?>
				...
				<?php
					...
					$position = mad_meta('mad_tm_position', '', $id);

					$facebook = mad_meta('mad_tm_facebook', '', $id);
					$twitter = mad_meta('mad_tm_twitter', '', $id);
					$gplus = mad_meta('mad_tm_gplus', '', $id);
					$pinterest = mad_meta('mad_tm_pinterest', '', $id);
					$instagram = mad_meta('mad_tm_instagram', '', $id);
				...
				<div class="team-item">
					...
					<?php if (has_post_thumbnail($id)): ?>
						...
						<div class="team-photo">
							<?php echo MAD_THEME_HELPER::get_the_post_thumbnail($id, '200*200', $thumbnail_atts) ?>
						</div><!--/ .team-photo-->
