				...
				<div class="images-item <?php echo esc_attr($animations) ?>">
					...
					<?php
						...
						if ( $attach_id > 0 ) {
							...
							$post_thumbnail['thumbnail'] = MAD_THEME_HELPER::get_the_thumbnail($attach_id, '440*345', $thumbnail_atts);
							$post_thumbnail['img_large'] = MAD_THEME_HELPER::get_post_attachment_image($attach_id, '');
						} else {
							$post_thumbnail = array();
