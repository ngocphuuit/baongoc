...
<p class="form-row form-group user-role">
    <input id="customer" type="radio" name="role" value="customer"<?php checked( $role, 'customer' ); ?>>
    <label for="customer" class="radio">
        <?php _e( 'I am a customer', 'dokan' ); ?>
    </label>

    <input id="seller" type="radio" name="role" value="seller"<?php checked( $role, 'seller' ); ?>>
