						...
						<div class="portfolio-item">
							...
							<div class="image-overlay <?php echo esc_attr($zoom_image); ?>">
								<div class="photoframe with-buttons">
									...
									<?php echo MAD_THEME_HELPER::get_the_post_thumbnail($id, '550*345', $thumbnail_atts); ?>
								...
								<?php if (!empty($cur_terms)): ?>
									<div class="post-meta">
										<?php foreach($cur_terms as $cur_term): ?>
											<a href="<?php echo get_term_link( (int) $cur_term->term_id, $cur_term->taxonomy ); ?>"><?php echo esc_html($cur_term->name); ?></a>
										<?php endforeach; ?>
									</div><!--/ .post-meta-->
								<?php endif; ?>
