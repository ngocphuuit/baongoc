 ...
 * The Metaboxes class.
 */
class Flatastic_Theme_Metaboxes {
	...
	public function meta_boxes_array($meta_boxes) {
		...
		$mad_registered_sidebars = MAD_THEME_HELPER::get_registered_sidebars(array("" => 'Default Sidebar'), array('General Widget Area'));
