...
class MAD_Select_Field extends MAD_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="mad-select-all-none">' . esc_html__( 'Select', 'flatastic' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'flatastic' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'flatastic' ) . '</a></div>';
		}
		return '';
	}
}
