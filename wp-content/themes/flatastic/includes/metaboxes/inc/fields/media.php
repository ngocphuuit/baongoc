...
class MAD_Media_Field extends MAD_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		self::localize_script( 'mad-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'mad_media_add_string', _x( '+ Add Media', 'media', 'flatastic' ) ),
			'single'             => apply_filters( 'mad_media_single_files_string', _x( ' file', 'media', 'flatastic' ) ),
			'multiple'           => apply_filters( 'mad_media_multiple_files_string', _x( ' files', 'media', 'flatastic' ) ),
			'remove'             => apply_filters( 'mad_media_remove_string', _x( 'Remove', 'media', 'flatastic' ) ),
			'edit'               => apply_filters( 'mad_media_edit_string', _x( 'Edit', 'media', 'flatastic' ) ),
			'view'               => apply_filters( 'mad_media_view_string', _x( 'View', 'media', 'flatastic' ) ),
			'noTitle'            => _x( 'No Title', 'media', 'flatastic' ),
			'loadingUrl'         => MAD_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => apply_filters( 'mad_media_select_string', _x( 'Select Files', 'media', 'flatastic' ) ),
			'or'                 => apply_filters( 'mad_media_or_string', _x( 'or', 'media', 'flatastic' ) ),
			'uploadInstructions' => apply_filters( 'mad_media_upload_instructions_string', _x( 'Drop files here to upload', 'media', 'flatastic' ) ),
		) );
	}
