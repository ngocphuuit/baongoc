...
$mad_elements[] = array(
	...
	$mad_elements[] = array(
		"name" 	=> esc_html__('Google Maps', 'flatastic'),
		"slug"	=> 'mad',
		"type" 	=> "heading",
		"desc" 	=> esc_html__('Google recently changed the way their map service works. New pages which want to use Google Maps need to register an API key for their website. Older pages should  work fine without this API key. If the google map elements of this theme do not work properly you need to register a new API key.', 'flatastic'),
	);

	$mad_elements[] = array(
		"name" 	=> esc_html__('Google Maps API Key', 'flatastic'),
		"slug"	=> 'mad',
		"type" 	=> "textarea",
		"id" 	=> "api-key-google-maps",
		"desc" 	=> esc_html__('Enter a valid Google Maps API Key to use all map related theme functions.', 'flatastic'),
		"std"   => ""
	);
