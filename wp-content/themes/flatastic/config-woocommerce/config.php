...
//			remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_rating', 10);
		...
		public function woocommerce_add_hooks() {
			...
			if ( version_compare( WC()->version, '2.4', '>=' ) ) {
				add_action('wc_ajax_' . $this->action_quick_view, array($this, 'mad_ajax_product_popup'));
				add_action('wc_ajax_' . $this->action_login, array(&$this, 'mad_ajax_form_login'), 30);
			} else {
									...
									register_taxonomy( $domain,
										...
										array(
											...
											'labels' => array(
												...
												'search_items' =>  __( 'Search', 'flatastic') . ' ' . $nicename,
												'all_items' => __( 'All', 'flatastic') . ' ' . $nicename,
												'parent_item' => __( 'Parent', 'flatastic') . ' ' . $nicename,
												'parent_item_colon' => __( 'Parent', 'flatastic') . ' ' . $nicename . ':',
												'edit_item' => __( 'Edit', 'flatastic') . ' ' . $nicename,
												'update_item' => __( 'Update', 'flatastic') . ' ' . $nicename,
												'add_new_item' => __( 'Add New', 'flatastic') . ' ' . $nicename,
												'new_item_name' => __( 'New', 'flatastic') . ' ' . $nicename
											),
											'show_ui' => false,
											'query_var' => true,
