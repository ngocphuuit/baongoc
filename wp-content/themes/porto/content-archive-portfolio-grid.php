                    ...
                    <?php if ($count > 1 && $portfolio_show_all_images) : ?><div class="porto-carousel owl-carousel m-b-none nav-inside show-nav-hover" data-plugin-options="<?php echo esc_attr($options) ?>"><?php endif; ?>
                        ...
                        foreach ($featured_images as $featured_image) :
                            ...
                            if ($attachment && $attachment_grid) :
                                ...
                                ?>
                                <img class="img-responsive<?php echo $portfolio_view == 'outimage' ? ' tf-none' : '' ?>" width="<?php echo $attachment_grid['width'] ?>" height="<?php echo $attachment_grid['height'] ?>" src="<?php echo $attachment_grid['src'] ?>" alt="<?php echo $attachment_grid['alt'] ?>" />
                                <?php
