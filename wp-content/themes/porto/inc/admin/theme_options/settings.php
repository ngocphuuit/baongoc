            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'description' => __('Please click <strong>"Save Changes"</strong> in <strong>Settings > Permalinks</strong> after save changes.', 'porto'),
                    ),
                    array(
                        'id' => "portfolio-name",
                        'type' => 'text',
                    ...
                    array(
                        ...
                        'options'=> array(
                            ...
                            'quote' => __('Author Quote', 'porto'),
                            '-' => 'None',
                        ),
                        'default' => array('like','date','cats','skills','client','quote','-')
                    ),
                )
            );
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "full" => array('alt' => __('Full', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_4.jpg'),
                            "large" => array('alt' => __('Large', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_5.jpg'),
                            "medium" => array('alt' => __('Medium', 'porto'), 'img' => porto_options_uri.'/images/portfolio_archive_style_6.jpg'),
                        ),
                        'default' => 'grid'
                    ),
                    array(
