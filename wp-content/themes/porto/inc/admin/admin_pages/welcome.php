...
<div class="wrap about-wrap porto-wrap">
    <h1><?php _e( 'Welcome to Porto!-Null24.Net', 'porto' ); ?></h1>
    ...
    <div class="porto-section">
        <p class="about-description">
            <?php printf( __( 'Before you get started, please be sure to always check out <a href="%s" target="_blank">this documentation</a>. We outline all kinds of good information, and provide you with all the details you need to use Porto.', 'porto'), 'http://newsmartwave.net/wordpress/porto/documentation'); ?>
        </p>
        <p class="about-description">
        ...
        <p class="about-description">
            <a target="_blank" href="http://newsmartwave.net/wordpress/porto/documentation#changelog"><?php _e('Click here to view change logs.', 'porto') ?></a>
        </p>
        <p class="about-description">
            <?php
